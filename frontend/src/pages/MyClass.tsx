...
export default function MyClass() {
  ...
  if (user?.role !== 'CLASS_REPRESENTATIVE') {
    return <div className="p-10 text-center text-slate-500 font-bold">Only Class Representatives can view this page.</div>;
  }
    ...
    <div className="space-y-6 animate-in fade-in duration-500 max-w-[1200px] mx-auto pb-10">
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl border border-[#dbe8d8] shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#017a80]">My Class Students</h1>
            <p className="text-[#01949a]/70 font-medium mt-1">CSBS Department - {yearMatch} Year</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="bg-white p-6 rounded-2xl border border-[#dbe8d8] shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-sm font-bold text-[#01949a]/60 uppercase tracking-wider">Total Strength</p>
            <h3 className="text-3xl font-bold text-[#017a80]">{students.length}</h3>
          </div>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-[#dbe8d8] shadow-sm flex items-center gap-4">
          <div className="p-4 bg-indigo-50 text-indigo-600 rounded-full"><User className="w-6 h-6" /></div>
          <div>
            <p className="text-sm font-bold text-[#01949a]/60 uppercase tracking-wider">Boys</p>
            <h3 className="text-3xl font-bold text-[#017a80]">{boysCount}</h3>
          </div>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-[#dbe8d8] shadow-sm flex items-center gap-4">
          <div className="p-4 bg-pink-50 text-pink-600 rounded-full"><User className="w-6 h-6" /></div>
          <div>
            <p className="text-sm font-bold text-[#01949a]/60 uppercase tracking-wider">Girls</p>
            <h3 className="text-3xl font-bold text-[#017a80]">{girlsCount}</h3>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-[#dbe8d8] shadow-sm overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm text-[#017a80]">
            <thead className="bg-[#f4f8f3]/50 text-[#01949a] uppercase font-bold text-[11px] tracking-wider border-b border-[#dbe8d8]">
              <tr>
            ...
            <tbody className="divide-y divide-[#dbe8d8]">
              {students.map((student, idx) => (
                <tr key={student.rollNo} className="hover:bg-[#f4f8f3]/30 transition-colors font-medium">
