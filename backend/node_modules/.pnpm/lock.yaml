...
importers:
  ...
  .:
    dependencies:
      ...
      web-push:
        specifier: ^3.6.7
        version: 3.6.7(supports-color@5.5.0)
      zod:
        specifier: ^4.6.5
        version: 4.6.5
    devDependencies:
      ...
      ts-node:
        specifier: ^10.9.2
        version: 10.9.2(@types/node@26.6.1)(typescript@7.0.2)
      tsx:
        specifier: ^4.23.13
        version: 4.23.13
...
packages:
  ...
  fast-uri@4.1.5:
    resolution: {integrity: sha512-vZeoMRB4epNr7QfdHxel7te/RcX16CxyXI07JCCTFWZA2s4v1azGNESRj+2EoaHSaWFL/Z3GmKT2jF6A202jLg==}

  fastify-plugin@6.0.0:
    resolution: {integrity: sha512-fZOty7z3O7vOliF6d8bHE3wiEh1KcNnKEQensSgTk9C1DvN6nRLS++XVd86v33Hw/8u9Un8A1zDrQ8ujcQDHEg==}

  fastify@5.12.5:
    resolution: {integrity: sha512-OB2k1dlxs5/NAABqeKV2FUHkSD2BbENsCak8yULVcymn3fHIPDVa9TI3SDnJSWYSllZmSYuZXy2gTnsT+Sut1A==}
...
snapshots:
  ...
  ts-node@10.9.2(@types/node@26.6.1)(typescript@7.0.2):
    dependencies:
      '@cspotcode/source-map-support': 0.8.1
      '@tsconfig/node10': 1.0.13
      '@tsconfig/node12': 1.0.11
  ...
  web-push@3.6.7(supports-color@5.5.0):
    dependencies:
      asn1.js: 5.4.1
      http_ece: 1.2.0
      https-proxy-agent: 7.0.6(supports-color@5.5.0)
